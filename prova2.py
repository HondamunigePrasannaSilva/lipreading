...
def load_data(args):
    ...
    return face_vert_mmap,data2array_verts
...
def main():
    ...
    parser.add_argument("--verts_path", type=str, default="dataset/data_verts.npy")
    parser.add_argument("--vertices_npy_path", type=str, default="dataset/vertices_npy")
    parser.add_argument("--vertices_dim", type=int, default=5023*3)
    parser.add_argument("--data2array_verts_path", type=str, default='dataset/subj_seq_to_idx.pkl')
    args = parser.parse_args()

    face_vert_mmap,data2array_verts = load_data(args)
