...
"""Train of an MLP with landmark inputs,  to try and learn an embedding space that contains audio information
At Test time we need a pretrained LSTM model pretrained on audio"""
...
def create(config):
    ...
    # define the models
    model = MLP_emb(config.INPUT_DIM).to(device)
